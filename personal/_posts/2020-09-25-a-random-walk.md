---
layout: post
title:  Breadth-First Search of my Brain
author: Adam Berg
---
<!--more-->
...
This is where the story begins.  This is about the time that I need to make sure I have your attention, so along the way you'll find some thoughts about dogs, circles, tech companies, ADHD, autism, drugs, AI, mindfulness, at least one app idea, and some thoughts on social media. A final warning or reminder that these thoughts are out of order. I don't know if you are like me, but that's how they come for me. In my head they tend to be continuous, but actually extracting them into words is a slow and painful process (I imagine it like Dumbledore and his pensieve).
...
My brain would like to introduce the next thread of this story. The idea that everything is the same and returns to the same place. Throughout this story, this idea will be conveyed both explicitly and implicitly. Keep an eye out.

### Find your why
I've been doing a lot more reading than normal lately (it's becoming my normal, so that's probably the last time I can say that). [Start With Why](https://amzn.to/2EA5NuD) and [Find Your Why: A Practical Guide for Discovering Purpose for You and Your Team](https://amzn.to/3cyeuSP) are a couple of books I read earlier this year by Simon Sinek. The concept of category creation is VERY similar to the principles behind Sinek discusses in these books. Both essentially argue that have a solid reason for doing something will make you a leader in that area.  For Sinek, this is the "why".  For the pirates, this is the POV (Point of View).  See the [play bigger site](https://www.playbigger.com) for a better summary of what they're talking about.
...
Remember when this was about dogfooding and idea. Now I'm at a dog park talking about humans feeding food to their dogs.

I have left the typo on this one. I'm typing on my phone and cannot count the number of times it autocorrects incorrectly. I've recently started thinking about ADHD in general. Partially wondering if I have it and partially wondering if we all do. Part of all of this is me asking if this is how it goes down for everyone else? I'm pretty sure the answer is no, but I have no idea how someone else's brain works. 

I feel like I have two modes of operation. In one, thoughts are just constantly surfaced (or re-surfaced) and I cannot keep my attention on any specific one of them. The other mode, is the one I'm in right now. I've now been sitting here for potentially an hour and a half.  It is now 9:30 and I haven't gotten up to use the washroom, thought about food, or been all that interested in whatever random rabbit hole mode #1 decides to conjure up. 
...
What better segue into drugs than neuroscience. You are probably now wondering if I've been high this whole time. And if you weren't you certainly are now. Take a moment to absorb your gut reaction. Is it judgment?  Indifference?
...
I would love to hear thoughts that people had while reading, but I don't think comments are necessarily the right answer. For now, I think email is the simplest solution. Your comment is most likely directed at me, so there's no need for it to distract away from the original content.

### Email under rated
From there, email is an underated medium for asynchronous slow conversation. I may not respond right away, but I do clear out my inbox at regular intervals - so eventually I should. 
...
### Actually feel calm
Past me is calm, but current me just realized the amount of time that has elapsed between these thoughts is tiny. I'm approaching the three hour mark of writing details, but I'm still seated on the bench. I have maybe been at the park for under five minutes, and it's taken me three hours to barely scratch the surface of what these condensed thoughts actually are.

### Shoulders relaxed

![Calm]({{"/assets/images/calm-nature.jpg" | relative_url}})

As I write this I observe my shoulders have lifted themselves to their default position a couple inches above where they should actually be.
